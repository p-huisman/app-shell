...
export type BlazorWebAssemblyOptions<ExtraProps = {}> = {
  ...
  appExtensions?: BlazorWebAssemblyAppExtension[];
...
// with of them. This causes any global .NET and Blazor runtime objects to be overwritten.
//
  ...
  if (blazorAppState.blazor === undefined) {
    ...
    await blazorAppState.blazor.start({
      ...
      loadBootResource: function (
        ...
        const url = new URL(defaultUrl, assetBaseUrl).href;
        switch (_type) {
          case "dotnetjs":
            return url;
          default:
